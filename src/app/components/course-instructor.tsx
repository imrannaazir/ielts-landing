...
const CourseInstructor: FC<CourseInstructorProps> = ({ instructor }) => {
  const instructorValue: InstructorValue = instructor.values[0];
  return (
    <section className="py-6 w-full space-y-4">
      <h2 className="font-semibold text-2xl">Course Instructor</h2>
